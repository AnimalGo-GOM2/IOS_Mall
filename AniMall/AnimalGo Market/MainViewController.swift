...
//        setRefreshControl()
    ...
    public func setPushID() {
        self.webView.evaluateJavaScript("localStorage.getItem(\"push_market_id\")") { (result, error) in
            ...
            if result as? String == nil {
                ...
                self.webView.evaluateJavaScript("localStorage.setItem(\"push_market_id\", '" + pushToken + "')") { (result, error) in
                }
            }
        }
    }
...
extension MainViewController: WKNavigationDelegate {
    ...
    func webView(_ webView: WKWebView, didStartProvisionalNavigation navigation: WKNavigation!) {
        ...
        self.webView.startIndicatorLoading()
    ...
    func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
        ...
        self.webView.stopIndicatorLoading()
